...
*/
public class IREvaluatorIntroTest {
	/**
	...
	public void readModelAndUseRecomender() throws Exception {
		IREvaluatorIntro irevaluatorIntro = new IREvaluatorIntro(new FileDataModel(new File(CSV_FILE_PATH)));
		// TODO make cleanup
		Assert.assertNotNull(irevaluatorIntro);

		System.out.println(irevaluatorIntro.evaluate());
	}
}
